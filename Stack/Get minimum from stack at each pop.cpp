...
/* HINT :- Push the first element of the array in stack, then start comparing from second element
If top element of stack is greater than arr[i] then, add arr[i] to stack, otherwise add element again which is at top of the stack
